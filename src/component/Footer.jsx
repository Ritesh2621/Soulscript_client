...
const Footer = () => {
  return (
    <>
      <section class="py-10 bg-gray-50 sm:pt-16 lg:pt-24 mt-[30px]">
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
              <p class="text-sm font-semibold tracking-widest text-gray-400 uppercase">
                Get to know about the latest Blogs avlaible
              </p>

              <Link
              to='/'
                type="submit"
                class="border inline-flex items-center justify-center px-6 py-4 mt-7 font-semibold transition-all duration-200 hover:bg-slate-50 bg-black text-white hover:text-black rounded-md "
              >
                Explore Now
              </Link>
            </div>
